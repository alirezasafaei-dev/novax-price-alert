...
AUTH_ADMIN_TOKEN_INVALID = "توکن مدیریت نامعتبر است. دسترسی به این بخش محدود به مدیران سیستم است."
...
AUTH_INGEST_TOKEN_MISSING = (
    "توکن ارسال قیمت تنظیم نشده است. لطفاً متغیر INGEST_API_TOKEN را در تنظیمات سرور پیکربندی کنید."
)
...
ASSET_NOT_FOUND_FOR_SYMBOL = (
    "دارایی با نماد «{symbol}» یافت نشد. لطفاً از لیست دارایی‌ها انتخاب کنید."
)
ASSET_CODE_MISSING = "نماد دارایی (asset_code) ارسال نشده است."
ASSET_NOT_IN_DB = "دارایی در پایگاه داده ثبت نشده است."
ASSET_PRICE_UNAVAILABLE = "قیمت لحظه‌ای برای این دارایی در دسترس نیست. لطفاً بعداً تلاش کنید."
...
ALERT_MAX_ACTIVE_REACHED = (
    "به حداکثر تعداد هشدار فعال (۵ عدد) رسیده‌اید. لطفاً ابتدا یکی از هشدارهای فعلی را حذف کنید."
)
